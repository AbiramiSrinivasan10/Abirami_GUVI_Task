...
public class utility {
	...
	public static void readFromPropFile(String fileName) throws IOException {
		...
		FileReader file = new FileReader("C:\\Users\\girit\\eclipse-workspace\\Adactin\\Utils\\"+fileName+".properties");
		prop = new Properties();
		prop.load(file);
	}
	
	public static String[][] readExcel(String sheetName) throws IOException {
		XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\girit\\eclipse-workspace\\Adactin\\Utils\\AdactinTestData.xlsx");
	...
	public static String screenshot(String name) throws IOException {
		...
		String path="C:\\Users\\girit\\eclipse-workspace\\Adactin\\snap\\"+name+".png";
